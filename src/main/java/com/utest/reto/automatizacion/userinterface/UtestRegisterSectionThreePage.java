...
public class UtestRegisterSectionThreePage extends PageObject {
    ...
    public static final Target SELECT_INPUT_MOBILE = Target
    ...
    public static final Target INPUT_MOBILE = Target
            ...
            .located(By.xpath("//input[contains(@placeholder,'Select Brand')]"));

    public static final Target SELECT_LIST_MOBILE = Target
            .the("type the name of the mobile device")
            .located(By.xpath("//span[contains(@class,'ui-select-highlight')]"));

    public static final Target SELECT_INPUT_MODEL = Target
            .the("select the mobile device")
    ...
    public static final Target SELECT_LIST_MODEL = Target
            .the("type the name of the mobile device")
            .located(By.xpath("//span[contains(@class,'ui-select-highlight')]"));

    public static final Target SELECT_INPUT_OS = Target
            .the("select the mobile device")
    ...
    public static final Target SELECT_LIST_OS = Target
            .the("type the name of the mobile device")
            .located(By.xpath("//span[contains(@class,'ui-select-highlight')]"));
